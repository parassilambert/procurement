...
use AppBundle\Form\Type\ContractingUserType;
...
class ContractingUserController extends Controller{
    ...
    public function indexAction(){
        ...
        $content = $engine->render('AppBundle:Contracting:index.html.twig', array(
            // last username entered by the user
    ...
    public function contractViewAction(){
       $engine = $this->container->get('templating');
       $content = $engine->render('AppBundle:Contracting:contract_notices.html.twig');
       return $response = new Response($content);
    }
    /**
    ...
    public function contractStep2EditAction(Request $request,$id) {
         ...
         $form = $this->createForm(ContractStep2Type::class, $contract);
         $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            $data = $form->getData();
            $em->persist($data);
        ...
        $engine = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_section_I.html.twig',array('form' => $form->createView(),'contract' => $contract));
       return $response = new Response($content);
    }
    /**
    ...
    public function contractStep3EditAction(Request $request,$id) {
         ...
         $form = $this->createForm(ContractStep3Type::class, $contract);
         $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
             $data = $form->getData();
             $em->persist($data);
        ...
        $engine = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_section_II.html.twig',array('form' => $form->createView(),'contract' => $contract));
       return $response = new Response($content);
    }  
    /**
    ...
    public function contractStep4EditAction(Request $request,$id) {
        ...
        $form = $this->createForm(ContractStep4Type::class, $contract);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
        ...
        $engine = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_section_III.html.twig',array('form' => $form->createView(),'contract' => $contract));
       return $response = new Response($content);
    }
    ...
    public function contractDocumentViewAction($id){
        ...
        $engine  = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_section_IV.html.twig',array('contract'=>$contract));
      return $response = new Response($content);
    }
    ...
    public function contractDocumentCreateAction(Request $request,$id) {
         ...
         $form = $this->createForm(ContractDocumentType::class, $contractdocument);
         $form->handleRequest($request);
         if ($form->isSubmitted()&& $form->isValid()) {
          $data = $form->getData();
          $em->persist($data);
         ...
         $engine = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_new_document.html.twig',array('form' => $form->createView(),'contract'=>$contract));
       return $response = new Response($content);
      }
    ...
    public function contractDocumentEditAction(Request $request, $id) {
         ...
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:contract_notice_edit_document.html.twig',array('form' => $form->createView(),'contract'=>$contractdocument->getContract()));
       return $response = new Response($content);
      }
    ...
    public function contractValidationAction($id){
        ...
        if (count($errors) > 0) {
          $engine  = $this->container->get('templating');
          $content = $engine->render('AppBundle:Contracting:contract_notice_validation.html.twig',array('contract'=>$contract,'errors' => $errors));
          return $response = new Response($content); 
        }
        $engine  = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:contract_notice_validation.html.twig',array('contract'=>$contract,'errors' => $errors));
    ...
    public function associatedDossierViewAction() {
         ...
         $query = $em->createQuery(
                                   ...
                                   )->setParameter('contractingUser',$user);
    ...
    public function activeDossierDetailsViewAction($id) {
         ...
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:active_dossier_details.html.twig',array('dossier' => $dossier,'contract' =>$id));
    ...
    public function dossierDetailsViewAction($id) {
         ...
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:dossier_details.html.twig',array('dossier' => $dossier,'contract' =>$id));
    ...
    public function dossierAssociatedOfficersViewAction($id) {
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:dossier_associated_officer.html.twig',array('contract'=>$id));
       return $response = new Response($content);
    }
    ...
    public function dossierAssociatedOfficersListAction($id) {
          ...
          $associatedofficers = $em->getRepository('AppBundle:ContractOfficer')
                         ->findBy( array('contract' => $id));
          $encoder = new JsonEncoder();
          $normalizer = new GetSetMethodNormalizer();
          $normalizer->setCircularReferenceHandler(function ($object) {
          ...
          $audit->setDossier($associatedofficers->getContract());
          $em->persist($audit);
          $em->flush();
          }
         return  new Response($jsonContent);
    ...
    public function dossierAssociatedOfficersNewAction(Request $request,$id) {
         ...
         $contractofficer->setContract($contract);
         $contractofficer->setPermission("Opener");
         $form = $this->createForm(ContractOfficerType::class, $contractofficer);
         $form->handleRequest($request);
         if ($form->isSubmitted() && $form->isValid()) {
             $data = $form->getData();
             $em->persist($data);
        ...
        return $this->redirectToRoute('contracting_view_dossier_associated_officers',array('id'=> $id),301);
         ...
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:new_dossier_associated_officer.html.twig',array('form' => $form->createView()));
        return $response = new Response($content);
    } 
    ...
    public function dossierPrequalifiedViewAction($id) {
         ...
         if (!$contract) {
          ...
          if($contract->getProcedureType()=="Open"){
            ...
            $engine = $this->container->get('templating');
            $content = $engine->render('AppBundle:Contracting:dossier_prequalified.html.twig',array('contract'=>$id));
            return $response = new Response($content); 
          }
    }
    ...
    public function dossierPrequalifiedNewAction(Request $request,$id) {
         ...
         $form = $this->createForm(PreQualifiedType::class, $prequalified);
         $form->handleRequest($request);
         if ($form->isSubmitted() && $form->isValid()) {
             $data = $form->getData();
         ...
         $engine = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:new_dossier_prequalified.html.twig',array('form' => $form->createView()));
        return $response = new Response($content);
    }
     ...
     public function sendMailAction($recipient)
      {
        ...
        ->setBody(
            $this->renderView(
                  'AppBundle:Emails:shortlist.html.twig'
             ),
            'text/html'
        );
    ...
    public function dossierPrequalifiedRemoveAction($id) {
     ...
     public function tenderOpenAction($id) {
         $engine  = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:tender_opening.html.twig',array('contract'=>$id));
        return $response = new Response($content);
     }
    ...
    public function tendersViewAction($id) {
        ...
        $engine  = $this->container->get('templating');
        $content = $engine->render('AppBundle:Contracting:tenders.html.twig',array('bid'=>$bid,'contract'=>$id));
      return $response = new Response($content);
    }
    ...
    public function bidEvaluationAction(Request $request,$id) {
        ...
        return $this->redirect($this->generateUrl('contracting_view_tenders',array('id'=> $bid->getContract()->getId())));
         ...
         $engine  = $this->container->get('templating');
         $content = $engine->render('AppBundle:Contracting:Sbid.html.twig', array(
    ...
    public function profileEditAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $user = $this->get('security.token_storage')->getToken()->getUser();
        $form = $this->createForm(ContractingUserProfileType::class, $user);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            $data = $form->getData();
            $em->persist($data);
    ...
    public function profileAccountViewAction()
    {
             ...
             $em->flush();
        return $this->render(
            'AppBundle:Contracting:profile_account.html.twig',array('user' => $user));
     } 
    ...
    public function passwordEditAction(Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $user = $this->get('security.token_storage')->getToken()->getUser();
        $form = $this->createForm(ContractingUserChangePasswordType::class, $user);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
            $data = $form->getData();
     ...
     * @Template()
     */
     public function registerContractingAction(Request $request)
    {                
        $user= new ContractingUser();
        $form = $this->createForm(ContractingUserType::class, $user);
        $form->handleRequest($request);
        if ($form->isSubmitted() && $form->isValid()) {
    ...
    $lastUsername = $authenticationUtils->getLastUsername();
    $engine = $this->container->get('templating');
    $content = $engine->render('AppBundle:Contracting:login.html.twig',
        array(
            // last username entered by the user
            'last_username' => $lastUsername,
            'error'         => $error,
